...
" <Space> / gs … ノートナビゲータ。モードは無い。2つのツールがあり、
"   それぞれの中では 1キー = 1つの意味に固定。⇥ でもう一方へ。
"   見分けは上のバー: 「◎ ノート名」= 打たない / 「検索 …▏」= 打つ。
"
"   ローカル(<Space>) … 今のノートのリンク。打たない。全部コマンド。
"     ラベル(1-0/英字)=1タップで潜る / jk 選択 / ⏎ 開く / ⌫ h 戻る / ␣ アンカー
"     f b プレビュー / c p 子親に追加 / y ヤンク / m M マーク / a アンカー移動
"     / 一時絞り込み / ⇥ グローバルへ / ⎋ 取消
"
"   グローバル(gs) … 全ノート検索。打つ。ラベルが無いので数字もクエリに入る。
"     打つ=絞る / ⌫ 消す(空なら戻る) / ↑↓ 選択 / →・⇥ 潜る / ⏎ 開く
