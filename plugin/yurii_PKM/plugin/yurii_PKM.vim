...
nnoremap <nowait> <silent> mu  <Cmd>call yurii_pkm#jump_section_header('up')<CR>
nnoremap <nowait> <silent> mt  <Cmd>call yurii_pkm#jump_down_top()<CR>
nnoremap <nowait> <silent> mb  <Cmd>call yurii_pkm#jump_down_bottom()<CR>
