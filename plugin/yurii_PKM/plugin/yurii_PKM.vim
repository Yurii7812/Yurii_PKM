...
nnoremap <silent> \uu       <Cmd>call yurii_pkm#jump_section_header('up')<CR>
nnoremap <silent> \dt       <Cmd>call yurii_pkm#jump_down_top()<CR>
nnoremap <silent> \db       <Cmd>call yurii_pkm#jump_down_bottom()<CR>
